# Ghost Sharks: The Fish With Teeth on Its Forehead

Open data behind the distribution map and depth chart of this Benthic Beasts video.

| File | What it is |
|---|---|
| `occurrences.csv` | Every usable record of *Chimaeriformes* retrieved from GBIF.org and OBIS on 2026-09-25 (24081 records). Column `usable_mapa` = `si` marks the 24081 records drawn on the map; `qc_flags` explains any exclusion |
...
1. All occurrence records with coordinates were downloaded from the GBIF and OBIS APIs on 2026-09-25.
...
GBIF.org (25 September 2026) Filtered export of GBIF occurrence data https://doi.org/10.15468/dd.n44mze
