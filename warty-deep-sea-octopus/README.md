# The Deep Sea Octopus That Guarded Her Eggs 53 Months

Open data behind the distribution map and depth chart of this Benthic Beasts video.

| File | What it is |
|---|---|
| `occurrences.csv` | Every usable record of *Graneledone* retrieved from GBIF.org and OBIS on 2026-09-25 (1672 records). Column `usable_mapa` = `si` marks the 1672 records drawn on the map; `qc_flags` explains any exclusion |
...
GBIF.org (25 September 2026) Filtered export of GBIF occurrence data https://doi.org/10.15468/dd.dedy8f
